        ...
        linear_extrude(height = txtHeight) {
            translate([centerBody, y_pos_txt_1]) 
                rotate ([0, 0, diagonalAngle])
                    text(txt_Name, size=txtSize, font=txtFonts, halign = "center", $fn=30);
//            translate([centerBody, 16]) 
//                text(txt_DiveCenter, size=txtSize, font=txtFonts, halign = "center", $fn=30);
        }
    }
}
// 
